...
<html lang="en">
  <head>
    ...
    <meta name="description" content="SPYUS2K18">
    <meta name="author" content="DRIV3RKR">
    <link rel="shortcut icon" href="http://ip-api.org/uploads/images/Spyus-Favi.png">

    <title>PAPI MAILER</title>
    <!-- JS -->
...
?>
      <div class="mt-3">
        <h1><span class="name-co">SPYUS MAILER 2K18</span></h1>
...
<form  action="" method="post" enctype="multipart/form-data" name="form1">
<div class="well">
<center><h1 class="krgrtz">SPYUS MAILER 2K18</h1></center><BR>
<div class="row">
...
<br>
<div class="row"><br>
  <div class="col-sm-6"><font class="fontBungee" >Message</font><br>
<textarea rows="10" class="paddingin fontBungee" name="message"><?php echo $message; ?></textarea>
  </div><br>
  <div class="col-sm-3"><font class="fontBungee">Emails</font><br>
    <textarea rows="10" class="paddingin fontBungee" name="emaillist"><?php echo $emaillist; ?></textarea></div>
</div><br>
<div class="col-sm-3"><font class="fontBungee">BCC Emails</font><br>
    <textarea rows="10" class="paddingin fontBungee" name="bcclist"><?php echo $bcclist; ?></textarea></div>
</div>
<br>
<div class="row">
...
?>
    ...
    <footer class="footer">
      <div class="container">
        <span class="krgrtz"><i class="fa fa-laptop" aria-hidden="true"></i> A TOOL CREATED BY BULDREG </span>
      </div>
    </footer>
